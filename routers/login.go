...
import (
	...
	"github.com/DonaldJoao/twittor/jwt"
	"github.com/DonaldJoao/twittor/models"
)

/* Login relaiza el login */
func Login(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		http.Error(w, "Usuario o Contrasena Invalidos "+err.Error(), 400)
		return
	}
	...
	if existe == false {
		http.Error(w, "Usuario o Contrasena Invalidos", 400)
		return
	}
